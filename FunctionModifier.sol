//Modifiers are code that can be run before or/and after a function call
...
contract FunctionModifier {
    ...
    //Modifiers can take inputs.This modifier checks that the address passed in is not zero address
    function validAddress(address _addr) {
